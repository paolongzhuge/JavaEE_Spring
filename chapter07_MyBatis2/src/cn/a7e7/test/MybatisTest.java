...
public class MybatisTest {
	...
	public void cacheOneTest(){
		...
		//第二次查询
		customer = sqlSession.selectOne("cn.a7e7.po.Customer.findCustomerById", 1);
		System.out.println(customer.toString());
		sqlSession.close();
	}
	/**
	...
	public void findAllUserTest() {
		//通过工具类获取SqlSession
		SqlSession sqlSession = MybatisUtils.getSession();
		//SqlSession执行映射文件中定义的SQL，并返回映射结果集
		List<User> list = sqlSession.selectList("cn.a7e7.po.User.findAllUser");
		for (User user : list) {
